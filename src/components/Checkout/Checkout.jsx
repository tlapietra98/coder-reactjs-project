...
const Checkout = ({confirmOrder}) => {
  ...
  return (
    <form className="checkoutForm" onSubmit={(e)=>handleConfirmOrder(e)}>
        ...
        <input type="number" value={buyerPhone} onChange={(e)=>setBuyerPhone(e.target.value)} placeholder='Write your phone number'/>
        <input type="email" value={buyerEmail} onChange={(e)=>setBuyerEmail(e.target.value)} placeholder='Write your email address'/>
